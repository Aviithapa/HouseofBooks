        ...
        <div class="row row-30">
            <div class="col-md-4 col-xl-5" style="text-align:center;">
                <div class="pr-xl-4 center"><a class="brand" href="{{url("/")}}">
                        <div class="logo-holder mt-5 center">
                    ...
                    <p style="margin-top: 10px; font-weight: 600; font-size: 16px;">We are the group od young motivated individuals devoted toward providing a platform for selling and buying second  hand books as well as first hand books.</p>
                    <!-- Rights-->
                </div>
            </div>
            <div class="col-md-2">
