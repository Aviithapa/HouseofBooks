        ...
        <div class="container">
            ...
            <form  method="post" action="{{url('request')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" name="faculty" class="form-control" placeholder="Book Faculty " value=""   />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" name="publication" class="form-control" placeholder="Book Publication " value=""   />
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <textarea  name="message" class="form-control Message" placeholder="Book Details *" style="width: 100%; height: 200px; padding: 20px" required ></textarea>
                        </div>
                    </div>
                    <div class="row">
