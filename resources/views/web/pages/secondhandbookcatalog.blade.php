                                        ...
                                        <div class="columns">
                                            <div class="cardsecondhand">
                                                ...
                                                <p class="prod-i-price">
                                                    ...
                                                    <a href="{{url('add/to/cart/'.$product->id)}}"><button class="btn btn-primary btn-round-sm btn-sm" style="font-size: 12px; font-weight: 600;">ADD TO CART</button></a>
                                                </p>
                                            </div>
                                        </div>
                                    @endif
