                ...
                <div class="section-filter">
                    <div class="section-filter-cont">
                        ...
                        <div class="section-filter-item opened" id="university">
                            <p class="section-filter-ttl">Course</p>
                            <div class="section-filter-fields">
                                <p class="section-filter-field">
                                    <input id="section-filter-checkbox3-1" value="on" type="checkbox" onclick="faculty('BBA')">
                                    <label class="section-filter-checkbox" for="section-filter-checkbox3-1" >BBA</label>
                                </p>
                                <p class="section-filter-field">
                                    <input id="section-filter-checkbox3-2" value="on" type="checkbox" onclick="faculty('BBS')">
                                    <label class="section-filter-checkbox" for="section-filter-checkbox3-2">BBS</label>
                                </p>
                                {{--                                <p class="section-filter-field">--}}
