            ...
            <form method="POST" action="{{ route('register',[$role]) }}">
               ...
               <span>{{ $errors->has('name') ? ' has-error' : '' }}</span>
                ...
                <label style="display: flex;text-align: left !important; align-items: unset !important; padding: 0px !important; ">
                    <input type="checkbox" style="width: unset !important; margin-top: 2px !important;" required> I agree with the <a style="color: #FF8800 !important; padding-left: 4px;" href="{{url('/termsandcondition')}}" target="_blank"> terms and condition</a>
                </label>
