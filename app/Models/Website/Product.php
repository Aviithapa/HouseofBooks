...
class Product extends Model
{
    ...
    protected $fillable = ['name','description','price','quantity','image','semester','faculty','edition','university','discount','publication','excerpt','user_id',"category","status","author","sub_category","nobel_category","level","best_selling","condition","give_away","sold_out"];
